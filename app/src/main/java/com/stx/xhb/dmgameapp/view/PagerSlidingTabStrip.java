...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabBackgroundResId = R.drawable.host_background_tab;
	private int transparentColorId = R.color.real_transparent;
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (pager.getAdapter() instanceof IconTabProvider) {
				...
				TextView tab = addTextTab(i, pager.getAdapter().getPageTitle(i).toString());
				tabs.add(tab);
			}
...
/*
	public void setTextTab(final int position, String title){
		tabsContainer.removeAllViews();
		tabCount = pager.getAdapter().getCount();
...
//		Bitmap b = BitmapFactory.decodeResource(getResources(),R.mipmap.line1);
//		return b;
//	}
